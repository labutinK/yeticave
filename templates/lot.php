        ...
        <div class="lot-item__right">
            <? if (isset($_SESSION['username'])): ?>
                <div class="lot-item__state">
                    <?php $res = expiration_calc(htmlspecialchars($lot["date_finish"])); ?>
                    <div class="lot-item__timer timer <? if ($res['hours'] < 14) echo 'timer--finishing'; ?>">
                        <?php echo $res['hours'] . " : " . $res['minutes']; ?>
                    </div>
